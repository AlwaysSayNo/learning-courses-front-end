...
@Directive({
  selector: '[appCourseDescriptionLength]',
  providers: [{provide: NG_VALIDATORS, useExisting: CourseDescriptionLengthDirective, multi: true}]
})
export class CourseDescriptionLengthDirective implements Validator {
